...
#### 17.DRO: Deep Recurrent Optimizer for Structure-from-Motion(深度学习的SFM)

- 论文：Xiaodong Gu*, Weihao Yuan*, Zuozhuo Dai, Chengzhou Tang, Siyu Zhu, Ping Tan, [DRO: Deep Recurrent Optimizer for Structure-from-Motion](https://arxiv.org/abs/2103.13201)
- 代码：https://github.com/aliyun/dro-sfm
